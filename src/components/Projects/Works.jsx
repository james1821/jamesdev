...
const Works = () => {
  ...
  const projects = [
    {
      ...
      description: "A Web-based Record Management System that I proposed and developed for Asia Pacific College of Business and Art in Rizal Nueva Ecija as part of my undergraduate capstone/thesis. The objective of this project is to streamline manual record management and digitalize student records",
      techStack: [
  ...
  return (
    <section id='Works' className='bg-primary-bg'>
      ...
      <div className=' flex md:flex-row justify-center gap-10 sm:flex-col md:w-[80%] '>

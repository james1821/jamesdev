...
function Exp() {
  ...
  return (
    <div>
      <h1 className=" text-center md:text-center text-6xl md:text-8xl font-bold pb-4 pt-10 text-primary bg-primary-bg">
        Background
      </h1>
      <div className="flex flex-col lg:flex-row justify-start bg-primary-bg ">
        <div className="w-full lg:w-1/2 md:pl-10">
          <h1 className="text-center md:text-center text-3xl md:text-4xl font-bold pb-4 pt-10 text-primary">
            Education and Work Experience
          </h1>
          <Background />
        </div>
        <div className="w-full lg:w-1/2 md:pr-10 flex flex-col">
          <h1 className="text-center text-3xl md:text-4xl font-bold pb-4 pt-10 text-primary">
            Tech Stack
          </h1>
